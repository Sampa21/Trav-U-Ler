...
/*********** Start Footer *********/
.footer{ width:100%; background-color:#F2F3F5;background-image:linear-gradient(315deg,#000000 0%,#414141 74%); float:right; padding:0px 0px; }
.footer-parts{ width:550px; float:left; padding:0px 25px;}
.footer-parts-h4{ color:#FFF; padding:20px 0px; font-size:18px; text-align:center;}
.footer-parts-p{ color:#FFF; font-size:14px; padding:5px 0px; line-height:26px; text-align:center;}
...
.form{ width:240px; border-radius:2px; padding:8px 10px; color:#000; font-size:16px; margin:20px auto; border:none; }
...
.footer-bottom{ width:100%; background:#3264b0; float:left; color:#FFF; text-align:center; font-size:12px; 
font-weight:bold; padding:15px 0px !important;}
/*********** End Footer *********/
<header>
<div style="text-align:left;">TRAV-U-LER></div>
<div class="s">
...
<div class="main">
  <div class="seven">
  <h1>TRAVEL AGENCY</h1>
	<center><span> Punyat Kuthe Pan</span></center>
  </div><br><br><br>
  <ul class="cards">
    <li class="cards_item">
      <div class="card">
